...
if(isset($_POST['submit'])){
    ...
    $sql="insert into students (s_name,roll_no,reg_no,email,ph_no,address,year,department,blood_grp) values('$s_name','$roll_no','$reg_no','$email','$ph_no','$address','$year','$department','$blood_grp')";

    $result=mysqli_query($con,$sql);

    if($result){
    	header('location:student_record_insert.php');
    }else{
