...
include 'connect.php';
$id=$_GET['updateid'];
$sql="select * from aluminae where id=$id";
...
if(isset($_POST['update'])){
    ...
    $sql="update aluminae set id='$id',aluminae_name='$aluminae_name',email='$email',ph_no='$ph_no',address='$address',blood_grp='$blood_grp' where id=$id";
			...
			<form method="POST">
			  ...
			  <div class="row">
			     ...
			     <div class="input-group">
				    <input type="text" name="aluminae_name" value="<?php echo $aluminae_name ?>" required>
