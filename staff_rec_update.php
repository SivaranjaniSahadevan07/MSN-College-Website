...
if(isset($_POST['update'])){
    ...
    $sql="update staffs set id='$id',staff_name='$staff_name',designation='$designation',qualification='$qualification',email='$email',ph_no='$ph_no',address='$address',department='$department',blood_grp='$blood_grp' where id=$id";
			...
			<form method="POST">
			  ...
			  <div class="row">
			     ...
			     <div class="input-group">
				    <input type="text" name="staff_name" value="<?php echo $staff_name ?>" required>
